...
export interface MessageInterceptionResult {
    cancel: boolean;
    /** Clear the composer after a successful intercepted send/edit. Defaults to false. */
    shouldClear?: boolean;
}

export type MessageSendListener = (channelId: string, messageObj: MessageObject, options: SendMessageOptions, props: SendMessageProps) => Promisable<void | MessageInterceptionResult>;
export type MessageEditListener = (channelId: string, messageId: string, messageObj: MessageObject) => Promisable<void | MessageInterceptionResult>;
