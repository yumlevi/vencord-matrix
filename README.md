# Disorder Vencord Matrix

An experimental Vencord desktop build that projects Matrix rooms into Discord's
native interface. It is derived from [Vencord](https://github.com/Vendicated/Vencord)
and is not supported by the Vencord project.
...
- This modifies privileged Electron code. Only install releases you trust and
  verify the setup hash through a channel independent of the download link.
...
## Installing upstream Vencord

For the unmodified upstream project, visit https://vencord.dev/download.
